...
<body>
    ...
    <div class="header">
        <div class="container">
            ...
            <div class="menu-wrap" style="background-image: url(img/grp2.jpg)">
    ...
    <div class="container">
        <div class="header-page ef-parallax-bg" style="background-image:url(img/gro1.jpg)">
                ...
                <div class="row" id="work-grid">
                    ...
                    <div class="col-md-4 col-sm-4 col-xs-12 mix branding">
                        <div class="img home-portfolio-image">
                            <img src="img/w1.jpg" alt="Portfolio Item">
                            <div class="overlay-thumb">
                                ...
                                <div class="details">
                                    <span class="title">LONG DRESSES</span>
                    ...
                    <div class="col-md-4 col-sm-4 col-xs-12 mix web">
                        <div class="img home-portfolio-image">
                            <img src="img/w2p.jpg" alt="Portfolio Item">
                            <div class="overlay-thumb">
                                <a href="javascript:void(0)" class="like-product">
                                    <i class="ion-ios-heart-outline"></i>
                                    <span class="like-product">Liked</span>
                    ...
                    <div class="col-md-4 col-sm-4 col-xs-12 mix graphic">
                        <div class="img home-portfolio-image">
                            <img src="img/w3p.jpg" alt="Portfolio Item">
                            <div class="overlay-thumb">
                                <a href="javascript:void(0)" class="like-product">
                                    <i class="ion-ios-heart-outline"></i>
                                    <span class="like-product">Liked</span>
                    ...
                    <div class="col-md-4 col-sm-4 col-xs-12 mix branding">
                        <div class="img home-portfolio-image">
                            <img src="img/l1.jpg" alt="Portfolio Item">
                            <div class="overlay-thumb">
                                <a href="javascript:void(0)" class="like-product">
                                    <i class="ion-ios-heart-outline"></i>
                                    <span class="like-product">Liked</span>
                                ...
                                <div class="details">
                                    <span class="title">#53406</span>
                                    <span class="info">Glitter organza A-line gown with strappy lace up back.
...
Variations
                    ...
                    <div class="col-md-4 col-sm-4 col-xs-12 mix branding">
                        <div class="img home-portfolio-image">
                            <img src="img/l2.jpg" width="168" height="247">
                            <div class="overlay-thumb">
                                <a href="javascript:void(0)" class="like-product">
                                    <i class="ion-ios-heart-outline"></i>
                                    <span class="like-product">Liked</span>
                                ...
                                <div class="details">
                                    <span class="title">#53824</span>
                                    <span class="info">Tie-dye print charmeuse gown with V neck wrap bodice, skirt slit, pockets, and spaghetti straps.</span>
                                </div>
                                <span class="btnBefore"></span>
                                <span class="btnAfter"></span>
                                <a class="main-portfolio-link" href="single-project.html"></a>
                    ...
                    <div class="col-md-4 col-sm-4 col-xs-12 mix branding">
                        <div class="img home-portfolio-image">
                            <img src="img/l3.jpg" alt="Portfolio Item" width="168" height="247">
                            <div class="overlay-thumb">
                                <a href="javascript:void(0)" class="like-product">
                                    <i class="ion-ios-heart-outline"></i>
                                    <span class="like-product">Liked</span>
                                ...
                                <div class="details">
                                    <span class="title">#53758</span>
                                    <span class="info">Sequins organza ball gown with off-the-shoulder sweetheart neckline.</span>
                                </div>
                                <span class="btnBefore"></span>
                                <span class="btnAfter"></span>
                                <a class="main-portfolio-link" href="single-project.html"></a>
                    ...
                    <div class="col-md-4 col-sm-4 col-xs-12 mix branding">
                        <div class="img home-portfolio-image">
                            <img src="img/l4.jpg" alt="Portfolio Item" width="168" height="247">
                            <div class="overlay-thumb">
                                <a href="javascript:void(0)" class="like-product">
                                    <i class="ion-ios-heart-outline"></i>
                                    <span class="like-product">Liked</span>
                                ...
                                <div class="details">
                                    <span class="title">#53788</span>
                                    <span class="info">Beaded fitted gown with V neckline and strappy back.</span>
                                </div>
                                <span class="btnBefore"></span>
                                <span class="btnAfter"></span>
                                <a class="main-portfolio-link" href="single-project.html"></a>
                    ...
                    <div class="col-md-4 col-sm-4 col-xs-12 mix branding">
                        <div class="img home-portfolio-image">
                            <img src="img/l5.jpg" alt="Portfolio Item" width="168" height="247">
                            <div class="overlay-thumb">
                                <a href="javascript:void(0)" class="like-product">
                                    <i class="ion-ios-heart-outline"></i>
                                    <span class="like-product">Liked</span>
                                ...
                                <div class="details">
                                    <span class="title">
#53630</span>
                                    <span class="info">Chiffon gown with ruched bodice, beaded belt and straps, and cold shoulder cape.</span>
                                </div>
                                <span class="btnBefore"></span>
                                <span class="btnAfter"></span>
                                <a class="main-portfolio-link" href="single-project.html"></a>
                    ...
                    <div class="col-md-4 col-sm-4 col-xs-12 mix branding">
                        <div class="img home-portfolio-image">
                            <img src="img/l6.jpg" alt="Portfolio Item" width="168" height="247">
                            <div class="overlay-thumb">
                                <a href="javascript:void(0)" class="like-product">
                                    <i class="ion-ios-heart-outline"></i>
                                    <span class="like-product">Liked</span>
                                ...
                                <div class="details">
                                    <span class="title">#51631</span>
                                    <span class="info">

Satin A-line with strappy lace up back and high skirt slit.</span>
                                </div>
                                <span class="btnBefore"></span>
                                <span class="btnAfter"></span>
                                <a class="main-portfolio-link" href="single-project.html"></a>
